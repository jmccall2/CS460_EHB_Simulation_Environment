...
public class EHB
{
    ...
    public void update() {
      ...
      //  System.out.println(SpeedInterface.getSpeed());
         //Use the Button interface to see if the button is active or not.
        if(_isActive)
        {
            _speed = SpeedInterface.getSpeed(); // Get the speed from the speed interface. // METERS PER SECOND.
        ...
        //     For immediate testing purposes just set the pressure to 100%.
            BrakeInterface.setPressure(50); // Set the pressure using the brake interface.
